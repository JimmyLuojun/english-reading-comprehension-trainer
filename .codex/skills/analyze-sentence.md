...
# Sentence Analysis Skill (Codex CLI)
...
Read the prompt output and produce a JSON object:
...
- `predicted_error_types`: 1–3 codes only from: G01 G02 G03 G04 G05 G06 G07 L01 L02 L03 L04 L05 L06 D01 D02 D03 D04 D05
...
result = save_sentence_analysis(db, <sentence_id>, raw_json, model="codex-claude")
